...
final class ProductItem extends StatelessWidget {
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              flex: 1,
              child: _buildProductImage(context,productModel.image),
            ),
            Expanded(
              flex: 1,
              child: _buildProductContent(context,productModel),
            ),
          ],
        ),
        context.spaceMediumValue,
  ...
  DecoratedBox _buildProductImage(BuildContext context, String image)
  {
    return DecoratedBox(
  ...
  Container _buildProductContent(BuildContext context,  ProductModel productModel)
  {
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              ...
              child: Text(
                productModel.bucket,
                style: TextThemeApp.instance!.greyTitleLarge(context),
              ),
            ),
            const Spacer(
              flex: 2,
